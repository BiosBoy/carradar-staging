      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to carradar.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to carradar, accessible from{' '}
            <a href='https://carradar.com.ua/' rel='external nofollow noopener' target='_blank'>
              https://carradar.com.ua/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <a href='carradar.com.ua/privacy' rel='external nofollow noopener' target='_blank'>
              carradar.com.ua/privacy
            </a>
          </p>
        </li>
      </ul>
